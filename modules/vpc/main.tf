...
# Private Subnets (optional, for databases/cache in future)
...
resource "aws_security_group" "redis_sg" {
  ...
  # Redis Cluster Bus port (for cluster communication)
  ingress {
...
resource "aws_security_group_rule" "redis_to_redis" {
  type                     = "ingress"
  from_port                = 6379
  to_port                  = 6379
  protocol                 = "tcp"
...
resource "aws_security_group_rule" "redis_cluster_bus" {
  type                     = "ingress"
  from_port                = 16379
  to_port                  = 16379
  protocol                 = "tcp"
